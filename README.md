...
![image](https://github.com/user-attachments/assets/8c11d512-2283-4c41-94be-246011297f9f)

### Result:

Flat Top Sampling was successfully simulated using a pulse train to sample a continuous-time message signal. The sampled waveform retained the amplitude of the original signal at discrete intervals with flat 
tops. The output waveform confirms accurate flat-top representation of the message signal samples.

### Hardware output waveform:

![image](https://github.com/user-attachments/assets/3633abfc-939c-4cb7-85f8-1d21d2fd4a94)
